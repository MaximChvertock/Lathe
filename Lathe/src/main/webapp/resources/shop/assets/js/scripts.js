(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($('.price-slider').length > 0) {
            ...
            var minmax = document.getElementById('price-id').value.split(',');
            
            $('.price-slider').slider();

            $('.price-min-max').text(minmax[0] + " - " + minmax[1] + "BLR");

            $('.price-slider').on("slide", function (slideEvt) {
                $('.price-min-max').text(slideEvt.value[0] + " - " + slideEvt.value[1] + "BLR");
            });
        }
