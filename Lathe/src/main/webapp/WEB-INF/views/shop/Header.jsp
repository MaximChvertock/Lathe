...
<header class="no-padding-bottom header-alt">
    <div class="container no-padding">
        ...
        <div class="col-xs-12 col-md-6 top-search-holder no-margin">
            ...
            <%--<%@ include file="SearchArea.jsp" %>--%>

        </div><!-- /.top-search-holder -->

        <%@ include file="CustomerCart.jsp" %>
    ...
    <%--<nav id="top-megamenu-nav" class="megamenu-vertical animate-dropdown">--%>
        <%--<div class="container">--%>
            <%--<div class="yamm navbar">--%>
                ...
                <%--&lt;%&ndash;<button type="button" class="navbar-toggle" data-toggle="collapse"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-target="#mc-horizontal-menu-collapse">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<span class="sr-only">Toggle navigation</span>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<span class="icon-bar"></span>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<span class="icon-bar"></span>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<span class="icon-bar"></span>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</button>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div><!-- /.navbar-header -->&ndash;%&gt;--%>

                <%--<div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">--%>
                    <%--<ul class="nav navbar-nav">--%>

                        <%--<li>--%>
                            <%--<a href="${pageContext.servletContext.contextPath}/shop/products" class="dropdown-toggle"--%>
                               <%--data-hover="dropdown" data-toggle="dropdown"><spring:message--%>
                                    <%--code="shop.side_menu.category.wheeldrives"/></a>--%>
                        <%--</li>--%>

                        <%--<li >--%>
                            <%--<a href="${pageContext.servletContext.contextPath}/shop/tires" class="dropdown-toggle"--%>
                               <%--data-hover="dropdown" data-toggle="dropdown"><spring:message--%>
                                    <%--code="shop.side_menu.category.tires"/></a>--%>
                        <%--</li>--%>
                    <%--</ul><!-- /.navbar-nav -->--%>
                <%--</div><!-- /.navbar-collapse -->--%>
        ...
        <%--<div id="breadcrumb-alt">--%>
            <%--<div class="container">--%>
                <%--<div class="breadcrumb-nav-holder minimal">--%>
                    <%--<ul>--%>
                        <%--&lt;%&ndash;<li class="dropdown breadcrumb-item">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#" class="dropdown-toggle" data-toggle="dropdown">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;Media Center&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Computer Cases &amp; Accessories</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">CPUs, Processors</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Fans, Heatsinks &amp; Cooling</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Graphics, Video Cards</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Interface, Add-On Cards</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Laptop Replacement Parts</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Memory (RAM)</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Motherboards</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Motherboard &amp; CPU Combos</a></li>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<li><a href="#">Motherboard Components</a></li>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<li class="breadcrumb-item">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="#">Home</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<li class="breadcrumb-item current">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<a href="index.php?page=compaore">Product Comparison</a>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                    <%--</ul>--%>
