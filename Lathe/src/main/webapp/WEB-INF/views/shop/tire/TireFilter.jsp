...
<div class="widget">
    ...
    <div class="body bordered">
        ...
        <form:form
                action="${pageContext.servletContext.contextPath}/shop/tires"
                method="post"
            ...
            <div class="category-filter">
                ...
                <!-- brands -->
                <label class="custom-collapse" for="brands"><h2><spring:message code="brands"/></h2></label>
                <input id="brands" type="checkbox">

                <div class="category-productFilter">
                    <ul>
                        <c:forEach var="brand" items="${brandList}">
                            <li>
                                <form:checkbox class="le-checkbox" path="tireBrands" value="${brand}"/>
                                <label>${brand}</label>
                            </li>
                        </c:forEach>
                    </ul>
            ...
            <div class="filter">
                ...
                <div class="price-range-holder">
                    ...
                    <input id="price-id"
                           ...
                           class="price-slider"
                           name="price"
                           value="<fmt:formatNumber type="number" pattern="############.##" value="${filter.minPrice}" />,<fmt:formatNumber type="number" pattern="############.##" value="${filter.maxPrice}" />"
                           ...
                           data-slider-step="1"
                           data-slider-value="[<fmt:formatNumber type="number" pattern="############.##" value="${filter.minPrice}" />,<fmt:formatNumber type="number" pattern="############.##" value="${filter.maxPrice}" />]"/>
            ...
            <span class="productFilter-button">
                <div class="buttons-holder">
                    ...
                    <a href="${pageContext.servletContext.contextPath}/shop/tires/filter-clear">clear</a>
                </div>
            </span>
        </form:form>
