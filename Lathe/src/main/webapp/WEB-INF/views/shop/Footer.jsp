    ...
    <%--<div class="container">--%>
        <%--<div class="row no-margin widgets-row">--%>
            <%--<div class="col-xs-12  col-sm-4 no-margin-left">--%>
                ...
                <%--&lt;%&ndash;<h2>Featured products</h2>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="body">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<ul>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-xs-12 col-sm-9 no-margin">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="single-product.html">Netbook Acer Travel B113-E-10072</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-prev">$2000</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-current">$1873</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>

                <%--&lt;%&ndash;<div class="col-xs-12 col-sm-3 no-margin">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-01.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-xs-12 col-sm-9 no-margin">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="single-product.html">PowerShot Elph 115 16MP Digital Camera</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-prev">$2000</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-current">$1873</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-02.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-03.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            ...
            <%--<div class="col-xs-12 col-sm-4 ">--%>
                <%--<!-- ============================================================= ON SALE PRODUCTS ============================================================= -->--%>
                <%--&lt;%&ndash;<div class="widget">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<h2>On-Sale Products</h2>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="body">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<ul>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-xs-12 col-sm-9 no-margin">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="single-product.html">HP Scanner 2910P</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-prev">$2000</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-current">$1873</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-04.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-xs-12 col-sm-9 no-margin">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="single-product.html">Galaxy Tab 3 GT-P5210 16GB, Wi-Fi, 10.1in -&ndash;%&gt;--%>
                <%--&lt;%&ndash;White</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-prev">$2000</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-current">$1873</div>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-05.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-06.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            ...
            <%--<div class="col-xs-12 col-sm-4 ">--%>
                <%--<!-- ============================================================= TOP RATED PRODUCTS ============================================================= -->--%>
                <%--&lt;%&ndash;<div class="widget">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<h2>Top Rated Products</h2>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="body">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<ul>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-xs-12 col-sm-9 no-margin">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="single-product.html">Galaxy Tab GT-P5210, 10" 16GB Wi-Fi</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-prev">$2000</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-current">$1873</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-07.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-08.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<div class="row">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="col-xs-12 col-sm-9 no-margin">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<a href="single-product.html">Surface RT 64GB, Wi-Fi, 10.6in - Dark&ndash;%&gt;--%>
                <%--&lt;%&ndash;Titanium</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-prev">$2000</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="price-current">$1873</div>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                ...
                <%--&lt;%&ndash;<a href="#" class="thumb-holder">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<img alt="" src="assets/images/blank.gif"&ndash;%&gt;--%>
                <%--&lt;%&ndash;data-echo="assets/images/products/product-small-09.jpg"/>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="${pageContext.servletContext.contextPath}/shop"><spring:message code="home"/>
                </div><!-- /.copyright -->
            </div>
            <%--<div class="col-xs-12 col-sm-6 no-margin">--%>
