            ...
            <ul class="submenu">
                ...
                <li>
                    <form class="formBox"
                        ...
                        <div class="formBox btn-submit"><!-- Submit form -->
                            <%--<input type="submit" value="Edit" class="button"--%>
                            <%--onclick="document.getElementById('action-image-id').value = 1;"/>--%>
                            <input type="submit" value="Remove" class="button"
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li>
                    ...
                    <form action="${pageContext.servletContext.contextPath}/admin/tires/add-tire-from-file?${_csrf.parameterName}=${_csrf.token}"
                          method="post"
                          enctype="multipart/form-data">
