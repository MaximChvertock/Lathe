...
@Entity
@Table(name="wheel_material")
@SQLInsert(
        sql = "INSERT INTO " +
                "wheel_material (name) values(?) " +
                "ON DUPLICATE KEY UPDATE " +
                "id = VALUES(id), " +
                "name = VALUES(name);"
)
public class WheelMaterial extends Model {
    ...
    public WheelMaterial(String name) {
        this.name = name;
    }
    ...
    public boolean equals(Object o) {
        ...
        WheelMaterial that = (WheelMaterial) o;
