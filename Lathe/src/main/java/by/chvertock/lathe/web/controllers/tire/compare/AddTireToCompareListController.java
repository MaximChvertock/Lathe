...
public class AddTireToCompareListController {
    ...
    @RequestMapping("shop/tires/add-to-compare")
    public String add(
        ...
        try {
            ...
            compareList.addTire(tire);
        } catch (DaoException e) {
            logger.error("Can't add tire to compare list", e);
        }
